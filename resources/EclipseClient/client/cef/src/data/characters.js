export const gender = { "male": 'mp_m_freemode_01', "female": 'mp_f_freemode_01' }
export const fathers = {'Benjamin': 0, 'Daniel': 1, 'Joshua': 2, 'Noah': 3, 'Andrew': 4, 'Juan': 5, 'Alex': 6, 'Isaac': 7, 'Evan': 8, 'Ethan': 9, 'Vincent': 10, 'Angel': 11, 'Diego': 12, 'Adrian': 13, 'Gabriel': 14, 'Michael': 15, 'Santiago': 16, 'Kevin': 17, 'Louis': 18, 'Samuel': 19, 'Anthony': 20, 'Claude': 42, 'Niko': 43, 'John': 44};
export const mothers = {'Hannah': 21, 'Aubrey': 22, 'Jasmine': 23, 'Gisele': 24, 'Amelia': 25, 'Isabella': 26, 'Zoe': 27, 'Ava': 28, 'Camila': 29, 'Violet': 30, 'Sophia': 31, 'Evelyn': 32, 'Nicole': 33, 'Ashley': 34, 'Gracie': 35, 'Brianna': 36, 'Natalie': 37, 'Olivia': 38, 'Elizabeth': 39, 'Charlotte': 40, 'Emma': 41, 'Misty': 45};
...
for (let i = 0; i < maxBlushColor; i++) blushColors.push(i);

export const lipstickColors = [];
for (let i = 0; i < maxLipstickColor; i++) lipstickColors.push(i);
